...
sources = [audio_source(1900,2800,40,40,180,away_distance,0,1.5),audio_source(2000,2600,40,40,0,away_distance,0.5,2)];
...
audio_out3 = AW_listening_new_improved(array_matrices,array_audio_signals,mega_coeffs,frequency_bands);
toc
